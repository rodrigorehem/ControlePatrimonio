(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('controlePatrimonialApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-controlePatrimonialApp-error');
                var entityKey = httpResponse.headers('X-controlePatrimonialApp-params');
                if (errorHeader) {
