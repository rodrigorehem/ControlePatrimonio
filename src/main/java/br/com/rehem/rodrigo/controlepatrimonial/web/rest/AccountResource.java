...
import br.com.rehem.rodrigo.controlepatrimonial.web.rest.dto.KeyAndPasswordDTO;
        ...
        return userRepository.findOneByLogin(managedUserDTO.getLogin())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserDTO.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    managedUserDTO.getCadastro(), managedUserDTO.getCarreira(), managedUserDTO.getLotacao(),
